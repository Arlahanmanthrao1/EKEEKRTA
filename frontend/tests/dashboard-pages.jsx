...
import { ActionCard, BulkAccountsPanel, CgpaPlannerPanel, CourseKnowledgePanel, FacultyContentDraftPanel, parseBulkCsv } from '../src/pages/AIAssistantPage';
import LectureNotesPanel, { LectureReviewControls } from '../src/components/dashboard/LectureNotesPanel';
...
for (const text of ['Lecture summaries', 'Verified lecture transcript', 'Prepare review draft', 'does not currently deliver recordings']) assert.ok(facultyLecture.includes(text));
...
console.log('PASS native AI actions, cited course assistant, reviewable lecture notes, CSV validation and correction consent');
